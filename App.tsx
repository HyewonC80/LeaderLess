...
export default function App() {
  ...
  const [materialList, setMaterialList] = useState([
    {
      id: 1,
      author: "김도연",
      title: "팀 프로젝트 주제 선정 및 시장 조사",
      content:
        "팀 프로젝트 주제 선정 및 시장 조사와 관련된 다양한 데이터입니다...",
      date: "2026-05-15",
      status: "완료",
    },
    {
      id: 2,
      author: "이수경",
      title: "경쟁 서비스 분석 및 차별점 도출",
      content: "경쟁 서비스인 A사, B사의 특징을 비교 분석한 결과입니다...",
      date: "2026-05-16",
      status: "검토 중",
    },
  ]);
  ...
  const Logo = ({ className = "h-8" }: { className?: string }) => (
    <div className={cn("flex items-center gap-2", className)}>
      <img src={"logo.png"} alt="LeaderLess Logo" className="h-[80%] w-auto" />
    </div>
  );
        ...
        <div className="flex items-center gap-4">
          <div className="hidden md:flex items-center bg-gray-100 rounded-full px-4 py-1.5 gap-2">
            ...
            <input
              ...
              className="bg-transparent border-none focus:outline-none text-sm w-32 lg:w-48 font-bold"
            />
          </div>
      ...
      <div className="flex flex-1 relative">
        ...
        >
          <div className="p-6 flex flex-col items-center border-b border-gray-50">
            ...
            {isSidebarOpen && (
              <span className="font-black text-lg text-gray-900">김도연</span>
            )}
          </div>
          ...
          <nav className="flex-1 p-4 space-y-1">
            <SidebarItem
              id="home"
              icon={Home}
              label={isSidebarOpen ? "홈" : ""}
            />
            <SidebarItem
              id="projects"
              icon={LayoutDashboard}
              label={isSidebarOpen ? "프로젝트 관리" : ""}
            />
            <SidebarItem
              id="materials"
              icon={Files}
              label={isSidebarOpen ? "자료 관리" : ""}
            />
            <SidebarItem
              id="progress"
              icon={BarChart3}
              label={isSidebarOpen ? "진행 현황" : ""}
            />
            <SidebarItem
              id="warnings"
              icon={AlertTriangle}
              label={isSidebarOpen ? "경고 현황" : ""}
            />
            <SidebarItem
              id="minutes"
              icon={ClipboardList}
              label={isSidebarOpen ? "회의록" : ""}
            />
            <SidebarItem
              id="feedback"
              icon={MessageSquare}
              label={isSidebarOpen ? "피드백" : ""}
            />
          </nav>
        </aside>
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {[
                      ...
                      <div
                        key={i}
                        className="bg-blue-50 rounded-2xl p-6 flex flex-col items-center justify-center border border-blue-100"
                      >
              ...
              {currentView === "materials" && (
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    >
                      <Upload className="w-4 h-4" />새 자료 제출
                    </button>
                  </div>
                  ...
                  <div
                    id="submission-form"
                    className="grid grid-cols-1 lg:grid-cols-2 gap-8 scroll-mt-20"
                  >
                    ...
                    <div className="bg-white rounded-3xl border border-gray-200 shadow-sm overflow-hidden flex flex-col h-[500px]">
                      <div className="p-4 bg-blue-600 text-white flex items-center justify-between shadow-md relative z-10">
                        ...
                        <button
                          ...
                          className="text-xs font-bold hover:underline bg-white/20 px-3 py-1 rounded-lg"
                        >
                          상세 분석 이동
                        </button>
                      </div>
                        ...
                        {!analysis && !isAnalyzing ? (
                          ...
                          <div className="space-y-8 animate-in fade-in slide-in-from-right-4">
                            <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm">
                              <h4 className="text-xs font-black text-blue-600 mb-3 uppercase tracking-wider border-b border-blue-50 pb-1">
                                요약
                              </h4>
                            ...
                            <div className="space-y-3">
                              ...
                              <div className="space-y-2">
                                {analysis?.strengths.map((s, i) => (
                                  <div
                                    key={i}
                                    className="bg-emerald-50/50 p-3 rounded-xl border border-emerald-100/50 text-xs font-bold text-gray-700 flex gap-2"
                                  >
                            ...
                            <div className="space-y-3">
                              ...
                              <div className="space-y-2">
                                {analysis?.improvements.map((im, i) => (
                                  <div
                                    key={i}
                                    className="bg-amber-50/50 p-3 rounded-xl border border-amber-100/50 text-xs font-bold text-amber-900 flex gap-2"
                                  >
                              ...
                              <section className="space-y-6">
                                ...
                                <div className="space-y-4">
                                  {analysis?.strengths.map((item, idx) => (
                                    <div
                                      key={idx}
                                      className="flex gap-4 p-4 rounded-2xl bg-gray-50 border border-gray-100 group transition-all hover:bg-blue-50 hover:border-blue-100"
                                    >
                              ...
                              <section className="space-y-6">
                                ...
                                <div className="space-y-4">
                                  {analysis?.improvements.map((item, idx) => (
                                    <div
                                      key={idx}
                                      className="flex gap-4 p-4 rounded-2xl bg-amber-50 border border-amber-100 group transition-all hover:bg-amber-100/50"
                                    >
